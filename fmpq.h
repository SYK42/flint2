...
FLINT_DLL int _fmpq_reconstruct_fmpz_mqrr(fmpz_t num, fmpz_t den, const fmpz_t a, const fmpz_t m, fmpz_t T);

FLINT_DLL int fmpq_reconstruct_fmpz(fmpq_t res, const fmpz_t a, const fmpz_t m);

FLINT_DLL int fmpq_reconstruct_fmpz_mqrr(fmpq_t res, const fmpz_t a, const fmpz_t m, fmpz_t T);
